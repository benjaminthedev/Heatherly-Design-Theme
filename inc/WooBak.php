...
function woo_sample_options( ) {
    ...
    if($fabric_terms) {
                ...
                <div class="content">
                 <div class="sod_custom">
                    <div class="fabric-custom-search">
                        ...
                        <input type="search" class="Search For Fabric" id="fabrics-search" aria-label="Search for fabrics" placeholder="Search for fabrics"></input>
                    </div>   
                </div>
                </div>
        ...
        <script>
            ...
            function myTimer() {
                 console.log('Loaded Now!! 4 seconds!)');

           

            document.querySelector('#fabrics-search').addEventListener('keyup', function (e) {

             let filterValue = document.getElementById('fabrics-search').value.toUpperCase();
            
                console.log(e.target.value.toUpperCase());

                const newTitle = document.getElementsByClassName('newTitle');

                for (var i = 0; i < newTitle.length; i++) {
                    var titles = newTitle[i];
                    titles.innerHTML = titles.innerHTML.toUpperCase();
                }
                    // Get lis from ul
                    // let li = document.querySelectorAll('li.collection-item');
                    let li = document.querySelectorAll('.newFilter');
                    console.log(li);
            ...
            // get swatch-is-hidden class
            // if class is present
            // then find parent 
            // display none to li.collection-item


            //or

            /*
            if class .swatch-is-hidden is hidden is active 
            then add a class to the li called hide me!
            then add the css
            ...
            */ 
            ...
            // let liNew = document.querySelectorAll('.swatch-is-hidden');
            // let liNew = document.querySelectorAll('.single-sample-swatch');

            // if(liNew.classList.contains("swatch-is-hidden")){
            //     console.log('contains swatch-is-hidden');
            // }    
        </script>
            ...
            display: none;
                ...
                <div class="content">
                    <div class="fabric-swatches-filter-list">
                        <div class="sod_custom">
                            <div class="label sod_label_custom"><label for="Fabric Color">Fabric Name</label></div>
                            <div class="value">														
                                <span class="sod_select focus" tabindex="0" data-cycle="false" data-links="false" data-links-external="false" data-placeholder-option="false" data-filter="">
                                    ...
                                    <span class="sod_list_wrapper sod_list_wrapper_custom">
                                        ...
                                        <span class="sod_option active sod_option_reset" title="Choose fabric name" data-value="">Choose fabric name</span>
                                            <?php foreach($fabric_terms as $fabric):
                    ...
                    <div class="attributes-swatches-container">
                        <?php	
                            ...
                            foreach($fabric_terms as $term) {
                                ...
                                <div class="newFilter single-sample-swatch">
                                <a class="single-sample-swatch single-swatch__sample" data-src="'.$thumb.'" data-src_full="'.$full.'" data-name="'.$term->name.'">
